  ...
  <div class="app-layout" v-else>
    ...
    <div class="main-layout">
      <nav class="sidebar">
        ...
        <a href="#" :class="{ active: currentView === 'miners' }" @click.prevent="currentView = 'miners'"><span class="dot dot-get"></span> 全局矿机表</a>
      ...
      <div class="main-content">
        ...
        <AllMiners v-if="currentView === 'miners'" />
...
import AllMiners from './components/AllMiners.vue'
